# Glossário de Termos e Padronização (PT-BR)

> **Documento Vivo de Terminologia**  
> *Este arquivo atua como o dicionário central do projeto. Consulte-o sempre antes de traduzir termos mecânicos ou de história para garantir uniformidade em todo o compêndio.*

---

## Regras de Uso

* O conteúdo da coluna **Tradução Oficial PT-BR** é a fonte absoluta de verdade. Use esses termos exatos nos arquivos do diretório `content/`.
* A coluna *Tradução Tria Editora* existe como referência futura para alinhar com possíveis lançamentos oficiais no Brasil.

---

## 1. Regras do Sistema (Year Zero Engine)

| Termo Original (EN) | Tradução Oficial PT-BR | Tradução Tria Editora (Futura) | Categoria |
| :--- | :--- | :--- | :--- |
| **Attributes** | Atributos | | Mecânica |
| **Strength** | Força | | Atributo |
| **Agility** | Agilidade | | Atributo |
| **Wits** | Raciocínio | | Atributo |
| **Empathy** | Empatia | | Atributo |
| **Skills** | Perícias | | Mecânica |
| **Talents** | Talentos | | Mecânica |
| **Pushing the Roll** | Empurrar a Rolagem | | Mecânica |
| **Darkness Points (DP)** | **PE (Pontos de Escuridão)** | | Recurso (Mestre) |
| **Hope** | Esperança | | Recurso (Jogador) |
| **Stress / Strain** | Estresse | | Condição |
| **Critical Injuries** | Lesões Críticas | | Dano |
| **Delving** | Escavação de Ruínas / Exploração | | Mecânica (v2) |
| **Space Combat** | Combate Espacial | | Mecânica (v1) |

---

## 2. O Terceiro Horizonte (Cenário Clássico)

| Termo Original (EN) | Tradução Oficial PT-BR | Tradução Tria Editora (Futura) | Categoria |
| :--- | :--- | :--- | :--- |
| **The Third Horizon** | O Terceiro Horizonte | | Mundo |
| **The Icons** | Os Ícones | | Religião / Entidades |
| **Firstcome** | **Pioneiros** | | Facção / Cultura |
| **Zenithians** | Zenitianos | | Facção / Cultura |
...
| **Dark Between the Stars** | **Escuridão Entre as Estrelas** | | Ameaça Cósmica |
| **Darkbound** | **A Escuridão** | | Manifestação / Perigo |
| **Coriolis Station** | Estação Coriolis | | Localização |
| **The Monolith** | O Monólito | | Localização |

---

## 3. O Horizonte Perdido / A Grande Escuridão (Expansão v2)

| Termo Original (EN) | Tradução Oficial PT-BR | Tradução Tria Editora (Futura) | Categoria |
| :--- | :--- | :--- | :--- |
| **The Lost Horizon** | O Horizonte Perdido | | Mundo |
| **The Great Dark** | A Grande Escuridão | | Tema / Cenário |
| **The Builders** | Os Construtores | | Raça Antiga |
