...
* **Capítulo 8 (Criação de Setor):** Concluído e modularizado na pasta `8. Criação de Setor/` (8 arquivos: hub do capítulo com metodologia sandbox/ficha de registro e tabela d100, 4 compêndios com as 100 Tags de Mundos oficiais e suas listas de inimigos/amigos/complicações/coisas/lugares, regras exaustivas de sobrevivência para atmosfera/clima/biosfera com tabelas 2d6, demografia planetária e níveis tecnológicos NT0 a NT5 com tabelas 2d6, e regras para mundos secundários com gerador matricial d8/d10 de pontos de interesse).
...
* **Capítulo 16 (Inteligências Artificiais Verdadeiras):** Concluído e modularizado na pasta `16. Inteligências Artificiais Verdadeiras/` (4 arquivos: hub do capítulo/história/Draco/Pacto dos Primogênitos/Freios Quânticos/Agência do Perímetro e renascimento, anatomia dos núcleos quânticos/creche/compêndio de chassis/filactérias e reparos, a classe IA Verdadeira/processamento/tabela de nódulos +1 a +6/IA Heróica e variantes parciais, e compêndio de 11 Rotinas Centrais e 12 Rotinas Periféricas completas).
* **Capítulo 17 (Sociedades):** Concluído e modularizado na pasta `17. Sociedades/` (5 arquivos: hub do capítulo/filosofia sandbox/propósitos da cultura/conflitos acessíveis, matriz canônica de Origem da Sociedade d4-d20 com 20 razões de fundação, matriz canônica de Governantes d4-d20 com 12 formas de governo e 20 ameaças, matriz canônica de Classes Governadas d4-d20 com 12 fricções e 20 tendências, e sabor cultural com os 12 modelos históricos e matriz d4-d20 com 12 patronos e 20 peculiaridades/tabus).
* **Capítulo 18 (Mechas):** Concluído e modularizado na pasta `18. Mechas/` (5 arquivos: hub do capítulo/história do ECM Quântico de 2348 e geometria bípede de 2405/era de ouro e queda, regras de combate/escalas de blindagem/dano em Dados de Vida contra infantaria/interface neural vs manual e manutenção anual, engenharia e tabela canônica dos 9 chassis de mechas, compêndio de 22 módulos/7 defesas/16 armas de mecha e psitech, e compêndio das 9 fichas técnicas canônicas prontas para uso).
* **Status Geral de Conteúdo do Mestre (Capítulos 13 a 18 - Deluxe):** **100% CONCLUÍDO E REVISADO INTEGRALMENTE SEM RESUMOS**. Todos os capítulos suplementares de luxo foram modularizados e traduzidos com máxima fidelidade. As próximas revisões e expansões integrais focarão nos capítulos iniciais do livro básico (Capítulos 1 a 12).
